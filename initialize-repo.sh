...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-a32clusterfull6
echo     https://github.com/tfynes-pivotal/tap-gitops-a32clusterfull6
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-a32clusterfull6 --private
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-a32clusterfull6
git branch -M main
